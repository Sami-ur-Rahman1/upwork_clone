...
t = this, e = function() {
    ...
    var t = ["compactDisplay", "currency", "currencyDisplay", "currencySign", "localeMatcher", "notation", "numberingSystem", "signDisplay", "style", "unit", "unitDisplay", "useGrouping", "minimumIntegerDigits", "minimumFractionDigits", "maximumFractionDigits", "minimumSignificantDigits", "maximumSignificantDigits"],
        e = ["dateStyle", "timeStyle", "calendar", "localeMatcher", "hour12", "hourCycle", "timeZone", "formatMatcher", "weekday", "era", "year", "month", "day", "hour", "minute", "second", "timeZoneName"];
    ...
    function h() {
        ...
        var n = null,
            i = null;
        return 1 === t.length ? a(t[0]) || r(t[0]) ? i = t[0] : "string" == typeof t[0] && (n = t[0]) : 2 === t.length && ("string" == typeof t[0] && (n = t[0]), (a(t[1]) || r(t[1])) && (i = t[1])), {
            locale: n,
            params: i
        }
    }
    ...
    var k, w = {
        ...
        render: function(e, n) {
            ...
            var c = null,
                u = null;
            i(r.format) ? c = r.format : a(r.format) && (r.format.key && (c = r.format.key), u = Object.keys(r.format).reduce(function(e, n) {
                var a;
                return p(t, n) ? Object.assign({}, e, ((a = {})[n] = r.format[n], a)) : e
            }, null));
            var h = r.locale || l.locale,
                f = l._ntp(r.value, h, c, u),
    ...
    function M(t, e, n, r) {
        if (C(t, n)) {
            ...
            })(t, n) && v(e.value, e.oldValue) && v(t._localeMessage, a.getLocaleMessage(a.locale)) || I(t, e, n)
        }
    }
    ...
    function T(t, e, r, a) {
        ...
        } else n("Vue instance does not exists in VNode context")
    }

    function C(t, e) {
        var r = e.context;
        return r ? !!r.$i18n || (n("VueI18n instance does not exists in Vue instance"), !1) : (n("Vue instance does not exists in VNode context"), !1)
    }

    function I(t, e, r) {
        var a, o, s = function(t) {
                var e, n, r, a;
                i(t) ? e = t : l(t) && (e = t.path, n = t.locale, r = t.args, a = t.choice);
                return {
                    path: e,
                    locale: n,
                    args: r,
        ...
        if (c || u || h)
            if (c) {
                var p = r.context;
                t._vt = t.textContent = null != f ? (a = p.$i18n).tc.apply(a, [c, f].concat(D(u, h))) : (o = p.$i18n).t.apply(o, [c].concat(D(u, h))), t._locale = p.$i18n.locale, t._localeMessage = p.$i18n.getLocaleMessage(p.$i18n.locale)
            } else n("`path` is required in v-t directive");
        else n("value type not supported")
    }
        ...
        ! function(t) {
            ...
            return void 0 === t && (t = !1), t ? {
                ...
                beforeCreate: function() {
                    ...
                    if (t.i18n = t.i18n || (t.__i18nBridge || t.__i18n ? {} : null), t.i18n) {
                        if (t.i18n instanceof nt) {
                            ...
                            a && l(a) && (t.i18n.messages = g(t.i18n.messages, a)), this._i18n = new nt(t.i18n), this._i18nWatcher = this._i18n.watchI18nData(), (void 0 === t.i18n.sync || t.i18n.sync) && (this._localeWatcher = this.$i18n.watchLocale()), n && n.onComponentInstanceCreated(this._i18n)
                        }
                ...
                beforeMount: function() {
                    var t = this.$options;
                    t.i18n = t.i18n || (t.__i18nBridge || t.__i18n ? {} : null), t.i18n ? t.i18n instanceof nt ? (this._i18n.subscribeDataChanging(this), this._subscribing = !0) : l(t.i18n) && (this._i18n.subscribeDataChanging(this), this._subscribing = !0) : this.$root && this.$root.$i18n && this.$root.$i18n instanceof nt ? (this._i18n.subscribeDataChanging(this), this._subscribing = !0) : t.parent && t.parent.$i18n && t.parent.$i18n instanceof nt && (this._i18n.subscribeDataChanging(this), this._subscribing = !0)
                },
                mounted: e,
            ...
            update: M,
            unbind: T
        }), k.component(d.name, d), k.component(w.name, w), k.config.optionMergeStrategies.i18n = function(t, e) {
            return void 0 === e ? t : e
        }
    }
    var O = function() {
    ...
    function q(t) {
        var e, n, r, a = t.trim();
        return ("0" !== t.charAt(0) || !isNaN(t)) && (r = a, z.test(r) ? (n = (e = a).charCodeAt(0)) !== e.charCodeAt(e.length - 1) || 34 !== n && 39 !== n ? e : e.slice(1, -1) : "*" + a)
    }
    var J = function() {
    ...
    J.prototype.parsePath = function(t) {
        ...
        return e || (e = function(t) {
            ...
            function p() {
                var e = t[c + 1];
                if (u === H && "'" === e || u === P && '"' === e) return c++, r = "\\" + e, f[j](), !0
            }
            for (f[N] = function() {
                ...
                if ("\\" !== (e = t[++c]) || !p()) {
                    if (a = G(e), (i = (s = U[u])[a] || s.else || B) === B) return;
    ...
    var Z, Y = /<\/?[\w\s="/.':;#-\/]+>/,
        ...
        nt = function(t) {
            var e = this;
            void 0 === t && (t = {}), !k && "undefined" != typeof window && window.Vue && L(window.Vue);
    ...
    return nt.prototype._checkLocaleMessage = function(t, e, a) {
        var o = function(t, e, a, s) {
            if (l(a)) Object.keys(a).forEach(function(n) {
                var r = a[n];
                l(r) ? (s.push(n), s.push("."), o(t, e, r, s), s.pop(), s.pop()) : (s.push(n), o(t, e, r, s), s.pop())
            });
            else if (r(a)) a.forEach(function(n, r) {
                l(n) ? (s.push("[" + r + "]"), s.push("."), o(t, e, n, s), s.pop(), s.pop()) : (s.push("[" + r + "]"), o(t, e, n, s), s.pop())
            });
            else if (i(a)) {
                if (Y.test(a)) {
                    var c = "Detected HTML in message '" + a + "' of keypath '" + s.join("") + "' at '" + e + "'. Consider component interpolation with '<i18n>' to avoid XSS. See https://bit.ly/2ZqJzkp";
                    "warn" === t ? n(c) : "error" === t && function(t, e) {
        ...
        return this._vm.$watch("$data", function() {
            for (var e, n, r = (e = t._dataListeners, n = [], e.forEach(function(t) {
                    return n.push(t)
                }), n), a = r.length; a--;) k.nextTick(function() {
                r[a] && r[a].$forceUpdate()
            })
        }, {
            deep: !0
    ...
    }, rt.sync.get = function() {
        return this._sync
    }, rt.sync.set = function(t) {
        this._sync = t
    ...
    }, nt.prototype._warnDefault = function(t, e, n, r, a, o) {
        if (!c(n)) return n;
        if (this._missing) {
            var s = this._missing.apply(null, [t, e, r, a]);
            if (i(s)) return s
        }
        if (this._formatFallbackMessages) {
            var l = h.apply(void 0, a);
            return this._render(e, o, l.params, e)
        }
        return e
    }, nt.prototype._isFallbackRoot = function(t) {
        return (this._fallbackRootWithEmptyString ? !t : c(t)) && !c(this._root) && this._fallbackRoot
    ...
    }, nt.prototype._interpolate = function(t, e, n, a, o, s, h) {
        if (!e) return null;
        var f, p = this._path.getPathValue(e, n);
        if (r(p) || l(p)) return p;
        if (c(p)) {
            if (!l(e)) return null;
            if (!i(f = e[n]) && !u(f)) return null
        } else {
            if (!i(p) && !u(p)) return null;
            f = p
        }
        return i(f) && (f.indexOf("@:") >= 0 || f.indexOf("@.") >= 0) && (f = this._link(t, e, f, a, "raw", s, h)), this._render(f, o, s, n)
    }, nt.prototype._link = function(t, e, n, a, i, o, s) {
        var l = n,
            c = l.match(X);
        for (var u in c)
            if (c.hasOwnProperty(u)) {
                var h = c[u],
                    ...
                    _ = f[0],
                    m = f[1],
                    g = h.replace(_, "").replace(Q, "");
                if (p(s, g)) return l;
                s.push(g);
                var v = this._interpolate(t, e, g, a, "raw" === i ? "string" : i, "raw" === i ? void 0 : o, s);
                if (this._isFallbackRoot(v)) {
                    if (!this._root) throw Error("unexpected error");
                    var d = this._root.$i18n;
                    v = d._translate(d._getMessages(), d.locale, d.fallbackLocale, g, a, i, o)
                }
                v = this._warnDefault(t, g, v, a, r(o) ? o : [o], i), this._modifiers.hasOwnProperty(m) ? v = this._modifiers[m](v) : tt.hasOwnProperty(m) && (v = tt[m](v)), s.pop(), l = v ? l.replace(h, v) : l
            }
        return l
    }, nt.prototype._createMessageContext = function(t, e, n, i) {
        var o = this,
            s = r(t) ? t : [],
            l = a(t) ? t : {},
            c = this._getMessages(),
        ...
        return {
            ...
            locale: u,
            linked: function(t) {
                return o._interpolate(u, c[u] || {}, t, null, i, void 0, [t])
            }
        }
    }, nt.prototype._render = function(t, e, n, r) {
        if (u(t)) return t(this._createMessageContext(n, this._formatter || et, r, e));
        var a = this._formatter.interpolate(t, n, r);
        return a || (a = et.interpolate(t, n, r)), "string" !== e || i(a) ? a : a.join("")
        ...
        for (var r = !0, a = 0; a < e.length && "boolean" == typeof r; a++) {
            var o = e[a];
            i(o) && (r = this._appendLocaleToChain(t, o, n))
        }
        return r
        ...
        if (!n) {
            ...
            for (var o, s = [t]; r(s);) s = this._appendBlockToChain(n, s, e);
            (s = i(o = r(e) ? e : a(e) ? e.default ? e.default : null : e) ? [o] : o) && this._appendBlockToChain(n, s, null), this._localeChainCache[t] = n
        }
        return n
    }, nt.prototype._translate = function(t, e, n, r, a, i, o) {
        for (var s, l = this._getLocaleChain(e, n), u = 0; u < l.length; u++) {
            var h = l[u];
            if (!c(s = this._interpolate(h, t[h], r, a, i, o, [r]))) return s
        }
        return null
    }, nt.prototype._t = function(t, e, n, r) {
        for (var a, i = [], o = arguments.length - 4; o-- > 0;) i[o] = arguments[o + 4];
        if (!t) return "";
        var s, l = h.apply(void 0, i);
        ...
        return t ? (i(e) || (e = this.locale), this._i(t, e, this._getMessages(), null, n)) : ""
    ...
    }, nt.prototype._localizeDateTime = function(t, e, n, r, a, i) {
        for (var o = e, s = r[o], l = this._getLocaleChain(e, n), u = 0; u < l.length; u++) {
            var h = l[u];
            if (o = h, !c(s = r[h]) && !c(s[a])) break
        }
        if (c(s) || c(s[a])) return null;
        var f, p = s[a];
        if (i) f = new Intl.DateTimeFormat(o, Object.assign({}, p, i));
        else {
            var _ = o + "__" + a;
            (f = this._dateTimeFormatters[_]) || (f = this._dateTimeFormatters[_] = new Intl.DateTimeFormat(o, p))
        }
        return f.format(t)
    }, nt.prototype._d = function(t, e, n, r) {
        if (!n) return (r ? new Intl.DateTimeFormat(e, r) : new Intl.DateTimeFormat(e)).format(t);
        var a = this._localizeDateTime(t, e, this.fallbackLocale, this._getDateTimeFormats(), n, r);
        ...
        var o = this.locale,
            s = null,
            l = null;
        return 1 === n.length ? (i(n[0]) ? s = n[0] : a(n[0]) && (n[0].locale && (o = n[0].locale), n[0].key && (s = n[0].key)), l = Object.keys(n[0]).reduce(function(t, r) {
            var a;
            return p(e, r) ? Object.assign({}, t, ((a = {})[r] = n[0][r], a)) : t
        }, null)) : 2 === n.length && (i(n[0]) && (s = n[0]), i(n[1]) && (o = n[1])), this._d(t, o, s, l)
        ...
        if (i) f = new Intl.NumberFormat(o, Object.assign({}, p, i));
            ...
            var _ = o + "__" + a;
            (f = this._numberFormatters[_]) || (f = this._numberFormatters[_] = new Intl.NumberFormat(o, p))
        }
        return f
        ...
        var o = this.locale,
            s = null,
            l = null;
        return 1 === n.length ? i(n[0]) ? s = n[0] : a(n[0]) && (n[0].locale && (o = n[0].locale), n[0].key && (s = n[0].key), l = Object.keys(n[0]).reduce(function(e, r) {
            var a;
            return p(t, r) ? Object.assign({}, e, ((a = {})[r] = n[0][r], a)) : e
        }, null)) : 2 === n.length && (i(n[0]) && (s = n[0]), i(n[1]) && (o = n[1])), this._n(e, o, s, l)
    ...
    }), nt.install = L, nt.version = "8.28.2", nt
